...
(* OASIS_START *)
(* DO NOT EDIT (digest: da0a0e7658c166a73a3b7f654b4d43e6) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("nbd", None);
                           FindlibPackage ("nbd.lwt", None);
                           FindlibPackage ("uri", None);
                           FindlibPackage ("cohttp {>= 0.10.0}", None);
                           FindlibPackage ("cohttp.lwt", None);
                           FindlibPackage ("tar", None);
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "xenserver", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "src";
                      bs_compiled_object = Best;
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "öþâÓÜu-Ød\017Ñ\141u\149k\025";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
